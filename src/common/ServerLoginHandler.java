...
public class ServerLoginHandler extends ServerMessageHandler {
	...
	/**
	 * This method logs the client in by saving its id String and sends a
	 * message to all clients that the new client has logged in If already
	 * logged in (id String has been set) a message is sent to the client and no
