...
public class ChatClient1 extends AbstractClient {
	...
	public ChatClient1(String host, int port, ChatIF clientUI, String id) throws IOException {
	...
	/**
	 * This method handles a command message after the '#' has been stripped It
	 * uses reflection to create an instance of a subclass of ClientCommand
	 * whose name is given by the first token in the message string
	 *
	 * @param message
	 *            the command string (after '#' is stripped)
	 */
